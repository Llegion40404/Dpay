...
<template>
  <section id="more" class="container py-20 poco:px-2 phone:pb-0 semimd:pb-28">
      ...
      >
        ...
        >
          ...
          >
            ...
            <div>
              <h2
                class="font-bold text-xl text-indigo-500 dark:text-white mb-4 phone:mb-2"
              >
                {{ f.title }}
              </h2>
              <p
    ...
    <div class="group fixed top-[85vh] right-20">
      <a
        href="#top"
        class="fa-solid fa-angle-up z-50 rounded-full bg-gray-700 text-white px-[20px] py-5"
        ><span
